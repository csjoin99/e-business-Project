...
@section('title', 'Registrar foto de producto')
@section('css')
...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Registrar foto de producto</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <!-- form start -->
                        <form id="form" action="{{ route('product.photo.store',$product) }}" method="POST"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        name="order" placeholder="Ingresar orden" min="1" required>
                                    @error('order')
