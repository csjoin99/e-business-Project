            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <!-- form start -->
                        <form id="form" action="{{ route('coupon.store') }}" method="POST"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="code" placeholder="Ingresar código" maxlength="50" required>
                                    @error('code')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        id="discount" name="discount" placeholder="Ingresar descuento" min="0" required>
                                    @error('discount')
                                    <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        name="stock" placeholder="Ingresar stock" min="0" noDecimal="1" required>
                                    @error('stock')
                                    <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
