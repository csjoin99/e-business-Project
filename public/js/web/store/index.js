...
var vm = new Vue({
  ...
  methods: {
    ...
    get_products: function get_products() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee7() {
        var url, response, _yield$response$json9, data;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                url = "".concat(window.location.origin, "/api/get-products");
                _context7.next = 3;
                return fetch(url, {
                  method: "POST",
                  headers: {
                  ...
                  body: JSON.stringify({
                    order: _this6.filters.order,
                    category: _this6.filters.category,
                    range: _this6.filters.range
                  })
                });
              ...
              case 11:
                _yield$response$json9 = _context7.sent;
                data = _yield$response$json9.data;
                _this6.products = data;

                if (_this6.products.length == 1) {
                  _this6.total = "".concat(_this6.products.length, " Art\xEDculo");
                } else {
                  _this6.total = "".concat(_this6.products.length, " Art\xEDculos");
                }
    ...
    filter_order: function filter_order(event) {
      var _this7 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _this7.filters.order = event.target.value;
                _context8.next = 3;
                return _this7.get_products();
    ...
    filter_category: function filter_category() {
      var _this8 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                options = document.querySelectorAll('input[name="category-options"]');
                _context9.next = 3;
                return Array.prototype.slice.call(options).filter(function (item) {
                  return item.checked;
                }).map(function (item) {
                  return item.value;
                });
              ...
              case 3:
                _this8.filters.category = _context9.sent;
                _context9.next = 6;
                return _this8.get_products();
    ...
    filter_range: function filter_range() {
      var _this9 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                min = document.querySelector('input[name="min-range"]').value;
                max = document.querySelector('input[name="max-range"]').value;
                _this9.filters.range = [min, max];
                _context10.next = 5;
                return _this9.get_products();
  ...
  created: function created() {
    ...
    return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee11() {
      var _yield$_this10$get_ca, cart, coupon, order;
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              _context11.next = 2;
              return _this10.get_cart_content();

            case 2:
              _yield$_this10$get_ca = _context11.sent;
              cart = _yield$_this10$get_ca.cart;
              coupon = _yield$_this10$get_ca.coupon;
              order = _yield$_this10$get_ca.order;
              _this10.cart = cart;
              _context11.next = 9;
              return _this10.get_products();

            case 9:
              Object.assign(_this10.coupon, coupon);
              Object.assign(_this10.order, order);
