...
(() => {
/*!******************************************!*\
  !*** ./resources/js/confirm-deletion.js ***!
  \******************************************/
window.Swal = __webpack_require__(/*! sweetalert2 */ "./node_modules/sweetalert2/dist/sweetalert2.all.js");
document.getElementsByName("delete-button").forEach(function (button) {
...
document.getElementsByName("undo-button").forEach(function (button) {
  button.addEventListener("click", function (e) {
    e.preventDefault();
    Swal.fire({
      icon: "warning",
...
document.getElementsByName("cancel-button").forEach(function (button) {
  button.addEventListener("click", function (e) {
    e.preventDefault();
    Swal.fire({
      icon: "warning",
