...
"use strict";
/*!********************************************!*\
  !*** ./resources/js/admin/kardex/index.js ***!
  \********************************************/
...
var vm = new Vue({
  ...
  computed: {},
  methods: {
    check_kardex: function check_kardex() {
      var _this = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var product, range_date, url, response, _yield$response$json, data, _yield$response$json2, message;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                product = document.querySelector('select[id="product"]').value;
                range_date = document.querySelector('input[id="date"]').value;
              ...
              case 8:
                url = "".concat(window.location.origin, "/api/check-kardex");
                _context.next = 11;
                return fetch(url, {
                  method: "POST",
                  cache: "no-cache",
    ...
    submit: function submit() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
        var url, formData, response, _yield$response$json3, error;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 8:
                ...
                formData.append("product_list", JSON.stringify(_this2.product_list));
                formData.append("discount", _this2.discount);
