...
"use strict";
/*!***********************************************!*\
  !*** ./resources/js/admin/buy-order/index.js ***!
  \***********************************************/
  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!_this.product_list.some(function (item) {
              ...
              case 2:
                ...
                _this.product_list.push(_this.product);

                _this.search_list = _this.search_list.filter(function (item) {
                  return item.id !== product.id;
                });
    ...
    list_products: function list_products() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3() {
        var url, search, response, _yield$response$json, products, list_products;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                url = "".concat(window.location.origin, "/api/search-products-buy-order");
              ...
              case 8:
                ...
                list_products = products.map(function (product) {
                  return {
                    id: product.id,
                    name: product.name,
                ...
                _this3.search_list = list_products;
    ...
    submit: function submit() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee4() {
        var url, formData, response, _yield$response$json2, error;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _this4.submit_loading = true;

                if (_this4.product_list.length) {
                  _context4.next = 4;
                  break;
                }
              ...
              case 4:
                if (!_this4.product_list.some(function (item) {
                  return parseFloat(item.qty) <= 0 || parseFloat(item.qty) % 1 != 0;
                })) {
                  _context4.next = 6;
                  break;
                }
              ...
              case 10:
                url = "".concat(window.location.origin, "/api/store-buy-order");
                formData = new FormData();
                formData.append("product_list", JSON.stringify(_this4.product_list));
                /* formData.append("discount", this.discount); */

                formData.append("subtotal", _this4.subtotal);
                formData.append("total", _this4.total);
                ...
                formData.append("provider_id", _this4.provider.id);
                _context4.next = 19;
                return fetch(url, {
                  method: "POST",
                  cache: "no-cache",
              ...
              case 19:
                ...
                window.location.href = "".concat(window.location.origin, "/admin/buy-order");
                _context4.next = 30;
                break;
    ...
    list_providers: function list_providers() {
      var _this5 = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee5() {
        var url, search, response, _yield$response$json3, providers;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                url = "".concat(window.location.origin, "/api/search-providers");
                search = document.querySelector('input[id="search-providers"]').value;
                _context5.next = 4;
                return fetch(url, {
                  method: "POST",
                  cache: "no-cache",
              ...
              case 8:
                ...
                providers = _yield$response$json3.providers;
                _this5.provider_list = providers;
    ...
    set_provider: function set_provider(provider) {
      var _this6 = this;
